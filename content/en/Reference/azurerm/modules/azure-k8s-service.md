...
| `autoscaling_target_cpu_percentage` | See the [autoscaling](https://docs.opta.dev/reference/azurerm/modules/azure-k8s-service/#autoscaling) section. | `80` | False |
...
| `resource_request` | See the [container resources](https://docs.opta.dev/reference/azurerm/modules/azure-k8s-service/#container-resources) section. Default ```yaml cpu: 100 # in millicores memory: 128 # in megabytes ``` CPU is given in millicores, and Memory is in megabytes.  | `{'cpu': 100, 'memory': 128}` | False |
