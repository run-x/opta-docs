...
| `resource_request` | See the [container resources](https://docs.opta.dev/reference/aws/service_modules/aws-k8s-service/#container-resources) section. Default ```yaml cpu: 100 # in millicores memory: 128 # in megabytes ``` CPU is given in millicores, and Memory is in megabytes.  | `{'cpu': 100, 'memory': 128}` | False |
