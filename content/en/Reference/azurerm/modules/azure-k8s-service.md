...
| `resource_request` | See the [container resources](http://run-x.github.io/reference/azurerm/modules/azure-k8s-service/#resource-requests) section. CPU is given in millicores, and Memory is in megabytes.  | `{'cpu': 100, 'memory': 128}` | False |
