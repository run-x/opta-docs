...
| `resource_request` | See the [container resources](https://docs.opta.dev/reference/azurerm/modules/azure-k8s-service/#container-resources) section. CPU is given in millicores, and Memory is in megabytes.  | `{'cpu': 100, 'memory': 128}` | False |
