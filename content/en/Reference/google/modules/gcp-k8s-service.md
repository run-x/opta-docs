...
| `autoscaling_target_cpu_percentage` | See the [autoscaling](http://run-x.github.io/reference/google/modules/gcp-k8s-service/#autoscaling) section. | `80` | False |
| `autoscaling_target_mem_percentage` | See the [autoscaling](http://run-x.github.io/reference/google/modules/gcp-k8s-service/#autoscaling) section. | `80` | False |
...
| `resource_request` | See the [container resources](http://run-x.github.io/reference/google/modules/gcp-k8s-service/#container-resources) section. CPU is given in millicores, and Memory is in megabytes.  | `{'cpu': 100, 'memory': 128}` | False |
